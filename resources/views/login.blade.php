...
<br>
 ...
 <br>
  <button type="submit" class="btn btn-dark btn-lg btn-block" style="width:100%;">Login</button><br><br>
  <p>Don't have an account <span style="color:#C70A7D;"><a href="/register"
    style="color:#C70A7D;text-decoration:none;">Sign Up</a></span></p>
</form>
</div>
</div>
</body>
